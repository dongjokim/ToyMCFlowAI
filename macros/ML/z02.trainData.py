...
model0.add(Dense(1, kernel_initializer='normal', activation='softmax'))
...
# model1 = Sequential()
# model1.add(Flatten(input_shape=(16, 16, 1)))  # Images are a 3D matrix, we have to flatten them to be 1D
